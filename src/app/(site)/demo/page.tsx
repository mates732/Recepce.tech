...
/**
 * Veřejné demo Recepce.tech — ukázky pro klienty (UGO je výchozí).
 *
 * Stránka je zákaznická ukázka, ne admin: žádná autentizace, minimum textu
 * nad demo kartou — hlasový hovor je hrdino. Vždy je vidět jedno demo,
 * návštěvník si vybere v přepínači. Asistenti se řeší přes /api/vapi/session
 * (veřejný klíč + ID), soukromé klíče zůstávají na serveru.
 */
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 pb-16 pt-12 sm:pt-16 lg:px-8 lg:pb-24 lg:pt-20">
          <Reveal className="mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-xl text-[15px] leading-[1.75] text-ink/80 sm:text-base">
              Zavolejte si s AI asistentem UGO a vyzkoušejte, jak může během
              několika sekund odbavit běžné zákaznické dotazy.
            </p>
          </Reveal>
