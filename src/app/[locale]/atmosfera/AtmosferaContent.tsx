        ...
        <div className="mx-auto relative z-10" style={{ maxWidth: "1100px" }}>
          <div className="max-w-[800px] mb-16">
            <div
              ...
              onMouseEnter={(e) => { e.currentTarget.style.borderColor = "rgba(136,136,136,0.25)"; e.currentTarget.style.background = "rgba(136,136,136,0.1)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.borderColor = "rgba(136,136,136,0.1)"; e.currentTarget.style.background = "rgba(136,136,136,0.06)"; }}
            >
              <span
                ...
                style={{
                  ...
                  boxShadow: "0 0 0 3px rgba(136,136,136,0.1)",
                }}
              />
          ...
          <div className="mb-6">
            <span
              ...
              style={{ color: "rgba(136,136,136,0.2)" }}
              onMouseEnter={(e) => { e.currentTarget.style.color = "rgba(136,136,136,0.4)"; e.currentTarget.style.textShadow = "0 0 12px rgba(136,136,136,0.1)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.color = "rgba(136,136,136,0.2)"; e.currentTarget.style.textShadow = "none"; }}
            >
            ...
            {experiences.map((item, i) => (
              <div key={i}>
                <div
                  ...
                  style={{ color: "rgba(136,136,136,0.3)" }}
                  onMouseEnter={(e) => { e.currentTarget.style.color = "rgba(136,136,136,0.5)"; e.currentTarget.style.textShadow = "0 0 12px rgba(136,136,136,0.1)"; }}
                  onMouseLeave={(e) => { e.currentTarget.style.color = "rgba(136,136,136,0.3)"; e.currentTarget.style.textShadow = "none"; }}
                >
                  {isCs ? item.labelCs : item.labelEn}
                </div>
                <p className="font-body text-[14px] leading-relaxed" style={{ color: "#A0A0A0" }}>
          ...
          >
            <span className="font-body text-[10px] tracking-[0.2em] uppercase block mb-4" style={{ color: "rgba(102,102,102,0.35)" }}>
              &mdash; philosophy
            </span>
            <p className="font-body text-[15px] leading-relaxed" style={{ color: "#A0A0A0" }}>
              {isCs
