          ...
          <div className="space-y-6 font-body text-[15px] leading-relaxed" style={{ color: "#A0A0A0" }}>
            {isCs ? (
              <>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Jaké údaje shromažďujeme</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Cookies</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Sdílení údajů</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Vaše práva</h2>
              ...
              <>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">What data we collect</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Data sharing</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Your rights</h2>
