    ...
    <PageTransition>
      <section className="relative w-full pt-[clamp(120px,16vh,180px)] pb-24 px-[clamp(24px,5vw,64px)]">
        <div className="mx-auto max-w-[720px]">
          ...
          <div className="space-y-6 font-body text-[15px] leading-relaxed" style={{ color: "#A0A0A0" }}>
            {isCs ? (
              <>
                <p>Používáním této webové stránky a služeb recepce.tech souhlasíte s následujícími obchodními podmínkami.</p>
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Služby</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Platby</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Zrušení</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Odpovědnost</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Kontakt</h2>
                <p>Veškeré dotazy ohledně obchodních podmínek směřujte na vojanmatyas@gmail.com.</p>
                <p className="mt-8 font-body text-[13px]" style={{ color: "rgba(102,102,102,0.8)" }}>Poslední aktualizace: leden 2026</p>
              </>
            ) : (
              <>
                <p>By using this website and recepce.tech services, you agree to the following terms and conditions.</p>
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Services</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Payments</h2>
                <p>Service pricing is based on configuration and individual offer. Payments are made monthly based on issued invoice.</p>
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Cancellation</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Liability</h2>
                ...
                <h2 className="font-heading text-[18px] font-medium text-[#FAFAFA] mt-8 mb-3">Contact</h2>
                <p>Direct all questions regarding terms of service to vojanmatyas@gmail.com.</p>
                <p className="mt-8 font-body text-[13px]" style={{ color: "rgba(102,102,102,0.8)" }}>Last updated: January 2026</p>
              </>
            )}
          </div>
        </div>
