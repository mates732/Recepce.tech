            ...
            <ul className="flex flex-col gap-2.5 list-none">
              <li>
                <a
                  ...
                  aria-label={locale === "cs" ? "Napsat přes WhatsApp" : "Send a WhatsApp message"}
                  className="group flex items-center gap-2.5 text-sm text-[#5F6368] transition-colors duration-200 hover:text-[#111111] active:opacity-70"
                >
              ...
              <li>
                <a
                  ...
                  aria-label={locale === "cs" ? "Napsat SMS" : "Send an SMS"}
                  className="group flex items-center gap-2.5 text-sm text-[#5F6368] transition-colors duration-200 hover:text-[#111111] active:opacity-70"
                >
              ...
              <li>
                <a
                  ...
                  aria-label={locale === "cs" ? "Napsat e-mail" : "Send an email"}
                  className="group flex items-center gap-2.5 text-sm text-[#5F6368] transition-colors duration-200 hover:text-[#111111] active:opacity-70"
                >
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label={locale === "cs" ? "Otevřít Instagram" : "Open the Instagram profile"}
                  className="group flex items-center gap-2.5 text-sm text-[#5F6368] transition-colors duration-200 hover:text-[#111111] active:opacity-70"
                >
              ...
              {SOCIALS.youtube && (
                <li>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm text-[#5F6368] transition-colors duration-200 hover:text-[#111111]"
                  >
                    YouTube
                  </a>
                </li>
