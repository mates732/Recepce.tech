...
export default function Hero({ locale }: { locale: Locale }) {
  ...
  return (
    ...
    >
      ...
      {/* Layer 1: Entrance — plays once, owns opacity + y, never touches transform again */}
      <div
        style={{
          maxWidth: "1240px",
          width: "100%",
      ...
      >
        {/* Layer 2: Parallax — framer-motion owns this translateY */}
        <motion.div style={{ y: fgY, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
          {/* Layer 3: Floating — CSS owns this transform */}
